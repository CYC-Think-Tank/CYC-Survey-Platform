...
from api.dependencies import require_admin_context, require_admin_only, supabase
...
async def list_blog_posts(request: Request, include_unpublished: bool = False) -> Any:
    try:
        if include_unpublished:
            require_admin_only(await require_admin_context(request, require_team=False))
