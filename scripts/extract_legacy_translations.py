...
# This script extracts the French and Chinese translations from the old
# LanguageContext.tsx (from git history) and saves them as JSON files.

old_code = """const translations: Record<Language, Record<string, string>> = {
  en: {
    Admin: 'Admin',
    ...
    'Share your voice and help empower Canadian youth.':
      'Share your voice and help empower Canadian youth.',
    'Share your perspective on issues that matter.':
      'Share your perspective on issues that matter.',
    ...
    'We are preparing new surveys to gather your feedback. Please check back later to share your perspective!':
      'We are preparing new surveys to gather your feedback. Please check back later to share your perspective!',
    'START NOW': 'START NOW',
    MIN: 'MIN',
    ...
    'If you have a few more minutes, consider contributing to another active survey.':
      'If you have a few more minutes, consider contributing to another active survey.',
    'Participate in this survey to share your perspectives.':
      'Participate in this survey to share your perspectives.',
    'Take Survey': 'Take Survey',
    'There are no other active surveys at the moment. Please check back later!':
      'There are no other active surveys at the moment. Please check back later!',
    'Are you still there? Please select "Yes" to continue.':
      'Are you still there? Please select "Yes" to continue.',
    No: 'No',
    Yes: 'Yes',
    Maybe: 'Maybe',
    ...
    False: 'False',
    'out of': 'out of',
    'Please enter exactly 3 characters in the format A1A (letter, number, letter).':
      'Please enter exactly 3 characters in the format A1A (letter, number, letter).',
    'Enter the first 3 characters of your postal code (e.g. M5V).':
      'Enter the first 3 characters of your postal code (e.g. M5V).',
    'Follow Us!': 'Follow Us!',
    'Stay In Touch': 'Stay In Touch',
    'For CYC program updates, please sign-up for our mailing list:':
      'For CYC program updates, please sign-up for our mailing list:',
  ...
  fr: {
    ...
    'Share your voice and help empower Canadian youth.':
      "Faites entendre votre voix et contribuez a l'autonomisation des jeunes Canadiens.",
    'Share your perspective on issues that matter.':
      'Partagez votre point de vue sur les enjeux importants.',
    ...
    Continue: 'Continuer',
    'A valid email address is required to enter the raffle and to contact participants when the second and third questionnaires are released.':
      'Une adresse courriel valide est requise pour participer au tirage au sort ainsi que pour communiquer avec les participants lors de la publication des deuxième et troisième questionnaires.',
    'Email addresses will remain confidential and will not be shared publicly or used for purposes unrelated to the survey series or raffle administration.':
      'Les adresses courriel demeureront confidentielles. Elles ne seront ni divulguées publiquement ni utilisées à des fins autres que celles liées à la série de sondages ou à l’administration du tirage au sort.',
    'More Surveys Coming Soon': 'Plus de sondages à venir bientôt',
    'We are preparing new surveys to gather your feedback. Please check back later to share your perspective!':
      'Nous préparons de nouveaux sondages pour recueillir vos commentaires. Veuillez revenir plus tard pour partager votre point de vue !',
    'START NOW': 'COMMENCER',
    MIN: 'MIN',
    ...
    'Each survey completed is one entry.':
      'Chaque sondage complété correspond à une participation.',
    ...
    'Failed to submit survey. Please try again.':
      "Échec de l'envoi du sondage. Veuillez réessayer.",
    ...
    'Thank You!': 'Merci !',
    'Your responses have been successfully submitted. We greatly appreciate you taking the time to share your voice and help empower Canadian youth.':
      "Vos réponses ont bien été soumises. Nous vous remercions sincèrement d'avoir pris le temps de partager votre voix et de contribuer à l'autonomisation des jeunes Canadiens.",
    'Thanks for filling out the survey, we would really appreciate if you could share this survey with a friend in order to represent as many voices as possible.':
      "Merci d'avoir rempli le sondage, nous vous serions très reconnaissants de bien vouloir le partager avec un(e) ami(e) afin de représenter le plus grand nombre de voix possible.",
    'Keep Your Voice Heard': 'Faites entendre votre voix',
    'If you have a few more minutes, consider contributing to another active survey.':
      'Si vous avez quelques minutes de plus, pensez à répondre à un autre sondage actif.',
    'Participate in this survey to share your perspectives.':
      'Participez à ce sondage pour partager votre point de vue.',
    'Take Survey': 'Faire le sondage',
    'There are no other active surveys at the moment. Please check back later!':
      "Il n'y a aucun autre sondage actif pour le moment. Veuillez revenir plus tard !",
    'Are you still there? Please select "Yes" to continue.':
    ...
    'out of': 'sur',
    'Please enter exactly 3 characters in the format A1A (letter, number, letter).':
      'Veuillez entrer exactement 3 caractères au format A1A (lettre, chiffre, lettre).',
    'Enter the first 3 characters of your postal code (e.g. M5V).':
      'Entrez les 3 premiers caractères de votre code postal (ex. M5V).',
    'Follow Us!': 'Suivez-Nous !',
    'Stay In Touch': 'Restez en Contact',
    'For CYC program updates, please sign-up for our mailing list:':
      'Pour les mises à jour du programme CYC, veuillez vous inscrire à notre liste de diffusion :',
  ...
  zh: {
    ...
    Continue: '继续',
    'A valid email address is required to enter the raffle and to contact participants when the second and third questionnaires are released.':
      '需要有效的电子邮件地址才能参加抽奖，并在发布第二和第三份问卷时联系参与者。',
    'Email addresses will remain confidential and will not be shared publicly or used for purposes unrelated to the survey series or raffle administration.':
      '电子邮件地址将保密，不会公开发布，也不会用于与系列调查或抽奖管理无关的用途。',
    'More Surveys Coming Soon': '更多调查即将推出',
    'We are preparing new surveys to gather your feedback. Please check back later to share your perspective!':
      '我们正在准备新的调查以收集您的反馈。请稍后再来分享您的观点！',
    'START NOW': '现在开始',
    MIN: '分钟',
    ...
    'Select up to': '最多选择',
    'options': '项',
    'Strongly Disagree': '非常反对',
    'Neutral': '中立',
    'Strongly Agree': '非常同意',
    'Share your thoughts here...': '在这里分享您的想法...',
    'Thank You!': '谢谢！',
    'Your responses have been successfully submitted. We greatly appreciate you taking the time to share your voice and help empower Canadian youth.':
      '您的回复已成功提交。我们非常感谢您抽出宝贵时间分享您的声音，助力赋能加拿大青年。',
    'Thanks for filling out the survey, we would really appreciate if you could share this survey with a friend in order to represent as many voices as possible.':
      '感谢您填写问卷，如果您能将此问卷分享给朋友，我们将不胜感激，以便代表尽可能多的声音。',
    'Keep Your Voice Heard': '继续发声',
    'If you have a few more minutes, consider contributing to another active survey.':
      '如果您还有几分钟时间，请考虑参与其他进行中的调查。',
    ...
    'out of': '/',
    'Please enter exactly 3 characters in the format A1A (letter, number, letter).':
      '请输入恰好3个字符，格式为A1A（字母、数字、字母）。',
    'Enter the first 3 characters of your postal code (e.g. M5V).':
      '请输入您邮政编码的前3个字符（例如M5V）。',
    'Follow Us!': '关注我们！',
    'Stay In Touch': '保持联系',
    'For CYC program updates, please sign-up for our mailing list:':
      '获取CYC项目更新信息，请注册我们的邮件列表：',
    'Copyright © 2021. All rights reserved.': '版权所有 © 2021。保留所有权利。',
  },
};"""

def extract_lang_block(code):
    """Extract a language block from the TypeScript source."""
    pattern = rf"{code}: \{{(.*?)\n  \}},"
    match = re.search(pattern, old_code, re.DOTALL)
    if not match:
        raise ValueError(f"Could not find {code} block")
    block = match.group(1)
...
if __name__ == "__main__":
    for code in ["fr", "zh"]:
        data = extract_lang_block(code)
        out_path = f"src/locales/{code}.json"
        with open(out_path, "w", encoding="utf-8") as f:
            json.dump(data, f, ensure_ascii=False, indent=2)
        print(f"Wrote {out_path} with {len(data)} keys")
