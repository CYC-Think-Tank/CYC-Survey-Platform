...
export default function Home() {
  ...
  const baseItems = surveys.slice(0, 3).map((item) => {
    const displayTitle = (language === 'fr' && item.title_fr ? item.title_fr : language === 'zh' && item.title_zh ? item.title_zh : item.title) || item.title;
    const displayDescription = (language === 'fr' && item.description_fr ? item.description_fr : language === 'zh' && item.description_zh ? item.description_zh : item.description) || item.description;
