        ...
        <div className="card space-y-4">
          <div>
            ...
            <input type="text" required={language === 'en'} value={language === 'en' ? title : language === 'fr' ? titleFr : titleZh}
              ...
              placeholder={language === 'fr' ? 'Titre en francais' : language === 'zh' ? '中文标题' : 'e.g. Mental Health Perspectives 2026'} />
          </div>
          <div>
          ...
          {questions.map((q, qIdx) => (
            <div key={q.id} className={`card p-6 border-l-4 shadow-sm relative group ${q.type === 'section_header' ? 'border-l-[var(--color-cyc-accent)] bg-yellow-50/30' : 'border-l-[var(--color-cyc-primary)]'}`}>
              ...
              <div className="flex items-start space-x-4 mb-4 pr-28">
                ...
                <div className="flex-grow">
                  ...
                  <RichTextEditor
                    ...
                    placeholder={language === 'en' ? (q.type === 'section_header' ? 'Section Title' : 'Type your question here...') : language === 'fr' ? 'Traduction francaise' : '中文翻译'}
                  />
                </div>
              </div>
                ...
                <div className="space-y-3 ml-10 pr-28">
                  ...
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <RichTextEditor
                        ...
                        placeholder={language === 'en' ? 'Provide context or instructions before the next set of questions...' : language === 'fr' ? 'Traduction francaise du contexte...' : '中文描述...'}
                      />
                  </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                ...
                {((language === 'en' ? q.definitions : language === 'fr' ? (q.definitions_fr || q.definitions) : (q.definitions_zh || q.definitions)) || []).length > 0 && (
